        ...
        <div className='flex-1 relative flex flex-col h-screen'>
                ...
                {newChat ? (
                    <div className='flex flex-col items-center justify-center h-full font-light'>
                        ...
                        <div className='flex gap-10 mt-4'>
                            <div className='bg-custom-gray text-black mt-4 rounded-3xl w-60 pl-5 pr-4 pt-5 pb-7 text-lg h-40 border-2'>
            ...
            <div className='h-36 bg-gray-200'>
                <div className='flex justify-center items-center h-full'>
                    <textarea placeholder='Type your message here' className='w-3/4 h-2/3 rounded-lg px-4 resize-none'></textarea>
